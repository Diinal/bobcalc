...
namespace Bobcalc
{
    ...
    {   //Поля
        ...
        //TODO: rework to dinamical search in sheet for more flexibility when scanning
        ...
        public int convertwidthsec()
        {
            if (width == 1750) return 0;
            else if (1751 <= width && width <= 1875) return 1;
            else if (1876 <= width && width <= 2000) return 2;
            else if (2001 <= width && width <= 2125) return 3;
            else if (2126 <= width && width <= 2250) return 4;
            else if (2251 <= width && width <= 2375) return 5;
            else if (2376 <= width && width <= 2500) return 6;
            else if (2501 <= width && width <= 2625) return 7;
            else if (2626 <= width && width <= 2750) return 8;
            else if (2751 <= width && width <= 2875) return 9;
            else if (2876 <= width && width <= 3000) return 10;
            else if (3001 <= width && width <= 3125) return 11;
            else if (3126 <= width && width <= 3250) return 12;
            else if (3251 <= width && width <= 3375) return 13;
            else if (3376 <= width && width <= 3500) return 14;
            else if (3501 <= width && width <= 3625) return 15;
            else if (3626 <= width && width <= 3750) return 16;
            else if (3751 <= width && width <= 3875) return 17;
            else if (3876 <= width && width <= 4000) return 18;
            else if (4001 <= width && width <= 4125) return 19;
            else if (4126 <= width && width <= 4250) return 20;
            else if (4251 <= width && width <= 4375) return 21;
            else if (4376 <= width && width <= 4500) return 22;
            else if (4501 <= width && width <= 4625) return 23;
            else if (4626 <= width && width <= 4750) return 24;
            else if (4751 <= width && width <= 4875) return 25;
            else if (4876 <= width && width <= 5000) return 26;
            else if (5001 <= width && width <= 5125) return 27;
            else if (5126 <= width && width <= 5250) return 28;
            else if (5251 <= width && width <= 5375) return 29;
            else if (5376 <= width && width <= 5500) return 30;
            else if (5501 <= width && width <= 5625) return 31;
            else if (5626 <= width && width <= 5750) return 32;
            else if (5751 <= width && width <= 5875) return 33;
            else if (5876 <= width && width <= 6000) return 34;
            else return 34;

        }

        public int convertheightsec(string typesec)
        {
            if (typesec == "Classic")
            {
                return convertheightsecclassic();
            }

            if (typesec == "Trend")
            {
                return convertheightsectrend();
            }
            else
            {
                return 0;
        ...
        public int convertheightsecclassic()
        {
            if (height == 1750) return 0;
            else if (1751 <= height && height <= 1875) return 1;
            else if (1876 <= height && height <= 2000) return 2;
            else if (2001 <= height && height <= 2125) return 3;
            else if (2126 <= height && height <= 2250) return 4;
            else if (2251 <= height && height <= 2375) return 5;
            else if (2376 <= height && height <= 2500) return 6;
            else if (2501 <= height && height <= 2625) return 7;
            else if (2626 <= height && height <= 2750) return 8;
            else if (2751 <= height && height <= 2875) return 9;
            else if (2876 <= height && height <= 3000) return 10;
            else if (3001 <= height && height <= 3125) return 11;
            else if (3126 <= height && height <= 3250) return 12;
            else return 12;
        }

        public int convertheightsectrend()
        {
            if (height == 1750) return 0;
            else if (1751 <= height && height <= 1875) return 1;
            else if (1876 <= height && height <= 2000) return 2;
        ...
        public int convertheightsecfil()
        {
            if (height == 1700) return 0;
            else if (1701 <= height && height <= 1800) return 1;
            else if (1801 <= height && height <= 1900) return 2;
            else if (1901 <= height && height <= 2000) return 3;
            else if (1900 <= height && height <= 2100) return 4;
            else if (2101 <= height && height <= 2125) return 5;
            else if (2126 <= height && height <= 2250) return 6;
            else if (2251 <= height && height <= 2375) return 7;
            else if (2376 <= height && height <= 2500) return 8;
            else if (2501 <= height && height <= 2550) return 9;
            else if (2551 <= height && height <= 2625) return 10;
            else if (2626 <= height && height <= 2700) return 11;
            else if (2701 <= height && height <= 2825) return 12;
            else if (2851 <= height && height <= 2975) return 13;
            else if (2976 <= height && height <= 3000) return 14;
            else if (3001 <= height && height <= 3125) return 15;
            else return 15;
        }

        public int convertwidthsecfil()
        {
            if (width == 2110) return 0;
            else if (2110 <= width && width <= 2250) return 1;
            else if (2251 <= width && width <= 2375) return 2;
            else if (2376 <= width && width <= 2500) return 3;
            else if (2501 <= width && width <= 2625) return 4;
            else if (2626 <= width && width <= 2750) return 5;
            else if (2751 <= width && width <= 2875) return 6;
            else if (2876 <= width && width <= 3000) return 7;
            else if (3001 <= width && width <= 3125) return 8;
            else if (3126 <= width && width <= 3250) return 9;
            else if (3251 <= width && width <= 3375) return 10;
            else if (3376 <= width && width <= 3500) return 11;
            else if (3501 <= width && width <= 3625) return 12;
            else if (3626 <= width && width <= 3750) return 13;
            else if (3751 <= width && width <= 3875) return 14;
            else if (3876 <= width && width <= 4000) return 15;
            else if (4001 <= width && width <= 4125) return 16;
            else if (4126 <= width && width <= 4250) return 17;
            else if (4251 <= width && width <= 4375) return 18;
            else if (4376 <= width && width <= 4500) return 19;
            else if (4501 <= width && width <= 4625) return 20;
            else if (4626 <= width && width <= 4750) return 21;
            else if (4751 <= width && width <= 4875) return 22;
            else if (4876 <= width && width <= 5000) return 23;
            else return 13;
        }
    }
    ...
    class Wicket
    {
        ...
        public int height;
        public double discount;
        public int price_wick=0;
        public int price_fur=0;
    ...
    class Auto
    {
        ...
        public int price_rail=0;
        public int price_drive=0;
        public int price_controls=0;
        public int price_priemnik=0;
        public int price_photoel=0;
        public int price_lamp=0;
        ...
        public int Price_Total()
        {
            return price_rail + price_drive + price_controls + price_priemnik + price_photoel + price_lamp;
        }
    }
    ...
    public class excel
    {
        ...
        public static Excel.Worksheet exw, excelworksheet1, excelworksheet2, excelworksheet3, excelworksheet4, excelworksheet5;

        public static Excel.Range cellkp;
        static excel()
        {
            ...
            if (path != "")
            {
                ...
                excelworksheet3 = (Excel.Worksheet)excelsheets.get_Item(3);
                excelworksheet4 = (Excel.Worksheet)excelsheets.get_Item(4);
                excelworksheet5 = (Excel.Worksheet)excelsheets.get_Item(5);
            }
        }
    ...
    {
        public static void Senddata(string name, string unit, int count, int price, double discount, Excel.Application excelapp, Excel.Worksheet excelworksheet, int rubdiscount)
        {
            int k = 10;
            int l;
            //Поиск пустой строки
        ...
        public static void Send_GW_data(string OutGW, string OutEx, int price, double discount, int rubdiscount)
        {
            int k;
            int l;
            //Поиск пустой строки
        ...
        static void Main()
        {
            ...
            DateTime t = DateTime.Now + TimeSpan.FromSeconds(3.0);
            st.Show();
            ...
            st.Close();
            st.Dispose();
            System.Windows.Forms.Application.Run(new OtkatPage());
